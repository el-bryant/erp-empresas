<?php
$page_title = 'Otros egresos';
include_once('layouts/header.php');
?>

<!--Contenido de otros egresos-->
                ...
                <div class="card card-dashboard border-0 sombra my-5 p-3">
                    <form style="position: relative;">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control rounded-pill border-0 badge-claro"
                                id="txtRazonSocial">
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="form group">
                            ...
                            <div class="rounded-pill border-0 bg-turquesa py-2 text-center text-white mb-4">S/ 0.00
                            </div>
                        </div>
                        <div class="btn btn-azul rounded-pill px-5 text-white bold"
                            style="position: absolute; bottom: -8%; left: 38%;">Guardar</div>
                    </form>
                </div>
            </div>
            <!--Formulario de registro de egresos-->
